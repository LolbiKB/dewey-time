...
Should fix 6 open + 3 fixed (T3-9, T3-6, T2-1) · Can wait 3 open + 2 fixed (T3-5, T3-7) ·
Pending user/sandbox 2. (19 findings; **8 fixed total** — Must-fix bucket closed).
Remaining should-fix: UI T1-2/T1-3/T1-4 (in progress) + ops-visibility T3-2/T3-4 (need alerting-channel decision).
