...
Bucket counts (proposed): Must fix 1 open (T1-1) + 2 fixed (T2-3, T3-3) ·
Should fix 8 open + 1 fixed (T3-9) · Can wait 5 · Pending user/sandbox 2.
(19 findings; 3 fixed — all confirmed-correctness/security items closed)
