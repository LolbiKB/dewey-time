...
Should fix 7 open + 2 fixed (T3-9, T3-6) · Can wait 3 open + 2 fixed (T3-5, T3-7) ·
Pending user/sandbox 2. (19 findings; **7 fixed total** — Must-fix bucket closed;
all confirmed-correctness/security items resolved).
