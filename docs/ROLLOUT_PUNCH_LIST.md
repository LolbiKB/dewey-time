...
Should fix 3 open + 6 fixed (T3-9, T3-6, T2-1, T1-2, T1-3, T1-4) · Can wait 3 open + 2 fixed (T3-5, T3-7) ·
Pending user/sandbox 2. (19 findings; **11 fixed total** — Must-fix bucket closed).
Remaining should-fix: **T3-2 + T3-4 (ops-visibility — need an alerting-channel decision)**. Can-wait: T3-1 stray PNGs, T2-4 ATTENDANCE_ISSUE coverage, T3-10 test isolation.
