...
| `/assets/dewey_time/hr_attendance/assets/index.js` | `public/hr_attendance/assets/` (via bench symlink or sync copy) |

After deploy, Frappe Cloud usually symlinks:

`sites/assets/dewey_time/hr_attendance` → `apps/.../public/hr_attendance`
...
Implementation: `dewey_time/utils/sync_hr_attendance_assets.py`
