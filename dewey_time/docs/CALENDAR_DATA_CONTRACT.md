...
dewey_time does **not** submit HRMS shift documents. It **filters** ERPNext/HRMS data using the rules below when building the HR attendance calendar and closeout flags.
