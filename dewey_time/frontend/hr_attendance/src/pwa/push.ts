...
// refresh. Talks to dewey_time.webpush.* whitelisted methods. The app injects
...
export const getVapidPublicKey = () =>
  call<{ enabled: boolean; public_key: string }>("dewey_time.webpush.get_vapid_public_key");
export const savePushSubscription = (subscription: PushSubscriptionJSON) =>
  call("dewey_time.webpush.save_push_subscription", { subscription: JSON.stringify(subscription) });
export const deletePushSubscription = (endpoint: string) =>
  call("dewey_time.webpush.delete_push_subscription", { endpoint });
export const sendTestPush = () => call("dewey_time.webpush.send_test_push");
export const getBadgeCount = () => call<number>("dewey_time.webpush.get_my_badge_count");
